...
def generate_creator_html():
    try:
        ...
        # Define creator name style based on elite status
        name_style = """
            ...
            color: transparent;
            animation: gradientShift 3s ease-in-out infinite, shine 2s ease-in-out infinite;
        """ if is_elite else "color: #10FF92;"
